...
export class EarlyAdopterToken extends ethereum.SmartContract {
  static bind(address: Address): EarlyAdopterToken {
    return new EarlyAdopterToken("EarlyAdopterToken", address);
  }
